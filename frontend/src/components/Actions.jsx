...
import ConfettiButtonsc from "./ConfetiCatx";
import ConfettiButtonsu from "./ConfetiUnix";
import ConfettiButtonsd from "./ConfetiDogx";
      ...
      {/* ... other elements */}
			...
			<Modal isOpen={isOpen} onClose={onClose}>
				...
				<ModalContent>
					...
					<ModalFooter>
						<Button colorScheme='pink' size={"sm"} mr={3} isLoading={isReplying} onClick={handleReply}>
							Reply
						</Button>
					</ModalFooter>
